...
func TestAutoRoutingPrecedenceMatrix(t *testing.T) {
	...
	for _, tc := range cases {
		t.Run(tc.name, func(t *testing.T) {
			...
			got, _, ok := resolveAutoModel("auto", org, "", "", nil, chatReq("auto", "please refactor this function"), router.Slo{})
			if ok != tc.wantRouted {
...
func TestAutoRoutingOrgEnabledNeedsConfig(t *testing.T) {
	...
	if _, _, ok := resolveAutoModel("auto", "acme", "", "", nil, chatReq("auto", "hi"), router.Slo{}); ok {
