...
func TestBuildGenAISpanFields_ChatSuccess(t *testing.T) {
	...
	f := buildGenAISpanFields(rec, 0.0022, 0.0022, usdPtr(0.0015), usdPtr(0.0007), br, false)
...
func TestBuildGenAISpanFields_ErrorAndFallbacks(t *testing.T) {
	...
	f := buildGenAISpanFields(rec, 0, 0, usdPtr(0), usdPtr(0), nil, false)
...
func TestBuildGenAISpanFields_OrgSystemFallback(t *testing.T) {
	...
	m := attrMap(buildGenAISpanFields(rec, 0, 0, usdPtr(0), usdPtr(0), nil, false).attrs)
...
func TestBuildGenAISpanFields_Environment(t *testing.T) {
	withEnv := attrMap(buildGenAISpanFields(
		...
		0, 0, usdPtr(0), usdPtr(0), nil, false,
	).attrs)
...
func TestBuildGenAISpanFields_MessageRedaction(t *testing.T) {
	...
	off := attrMap(buildGenAISpanFields(rec, 0, 0, usdPtr(0), usdPtr(0), nil, false).attrs)
	...
	on := attrMap(buildGenAISpanFields(rec, 0, 0, usdPtr(0), usdPtr(0), nil, true).attrs)
...
func TestUsageCostCents_MatchesSpanTotal(t *testing.T) {
	...
	m := attrMap(buildGenAISpanFields(rec, spanTotalUSD, spanTotalUSD, usdPtr(0), usdPtr(0), nil, false).attrs)
...
func TestUsageBilledCents_BYOReconcilesInvoice(t *testing.T) {
	...
	m := attrMap(buildGenAISpanFields(&byo, totalUSD, billedUSD, usdPtr(0), usdPtr(billedUSD), nil, false).attrs)
