...
Note that using the Edge Runtime is optional but highly recommended due to [longer streaming timeouts on Vercel](https://hanzo.ai/docs/concepts/functions/edge-functions/limitations#maximum-initial-response-time), no cold starts, and lower latency.
