...
import type { BotProps } from '@hanzo/embed'
...
declare global {
    namespace JSX {
        interface IntrinsicElements {
            'hanzo-chatbot': React.DetailedHTMLProps<React.HTMLAttributes<HTMLElement>, HTMLElement> & { class?: string }
        }
    }
}
...
export const FullPageChat = ({ style, className, ...assignableProps }: Props) => {
    ...
    return <hanzo-chatbot ref={ref} style={style} class={className} />
}
