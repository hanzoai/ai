...
import { streamStorageFile } from '@hanzo/ai-components'
...
const getFileFromAssistant = async (req: Request, res: Response, next: NextFunction) => {
    try {
        ...
        if (!fileStream) throw new InternalHanzoError(StatusCodes.INTERNAL_SERVER_ERROR, `Error: getFileFromAssistant`)
