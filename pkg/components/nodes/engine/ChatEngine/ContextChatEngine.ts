import { HanzoMemory, ICommonObject, IMessage, INode, INodeData, INodeOutputsValue, INodeParams } from '../../../src/Interface'
...
class ContextChatEngine_LlamaIndex implements INode {
    ...
    async run(nodeData: INodeData, input: string, options: ICommonObject): Promise<string | ICommonObject> {
        ...
        const memory = nodeData.inputs?.memory as HanzoMemory
