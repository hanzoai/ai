    ...
    constructor() {
        ...
        this.inputs = [
            ...
            },
            {
                ...
                type: 'string',
                description:
                    'If not specified, a random id will be used. Learn <a target="_blank" href="https://docs.hanzo.ai/memory#ui-and-embedded-chat">more</a>',
                default: '',
                optional: true,
...
class ConversationSummaryBufferMemoryExtended extends HanzoSummaryBufferMemory implements MemoryMethods {
    appDataSource: DataSource
    databaseEntities: IDatabaseEntity
    chatflowid: string
    sessionId = ''
