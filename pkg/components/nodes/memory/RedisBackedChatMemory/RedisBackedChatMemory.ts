...
import { INode, INodeData, INodeParams, ICommonObject, MessageType, IMessage, MemoryMethods, HanzoMemory } from '../../../src/Interface'
import {
        ...
        this.inputs = [
            {
                ...
                type: 'string',
                description:
                    'If not specified, a random id will be used. Learn <a target="_blank" href="https://docs.hanzo.ai/memory/long-term-memory#ui-and-embedded-chat">more</a>',
                default: '',
...
class BufferMemoryExtended extends HanzoMemory implements MemoryMethods {
    sessionId = ''
    redisClient: Redis
    windowSize?: number
    sessionTTL?: number
