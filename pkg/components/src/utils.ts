...
const jsonEscapeCharacters = [
    { escape: '"', value: 'HANZO_DOUBLE_QUOTE' },
    { escape: '\n', value: 'HANZO_NEWLINE' },
    { escape: '\b', value: 'HANZO_BACKSPACE' },
    { escape: '\f', value: 'HANZO_FORM_FEED' },
    { escape: '\r', value: 'HANZO_CARRIAGE_RETURN' },
    { escape: '\t', value: 'HANZO_TAB' },
    { escape: '\\', value: 'HANZO_BACKSLASH' }
]
